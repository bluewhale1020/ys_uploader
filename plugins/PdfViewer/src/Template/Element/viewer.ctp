...
<div id="pdfviewer-container">
    <!-- <button id="prev" class="btn" onclick="goPrevious()"><i class="icon-chevron-left"></i> <?php echo __('前のページ');?></button> -->    &nbsp;
    <!-- <span>
    	<?php echo __('表示中');?>: <b><span id="page_num"></span></b> <?php echo __('of');?> <b><span id="page_count"></span></b>
    </span> -->
    &nbsp;
    <!-- <button id="next" class="btn" onclick="goNext()"><?php echo __('次のページ');?> <i class="icon-chevron-right"></i></button> -->

    <!-- Some niceness -->
    <span>
      <!-- Using TwitterBootstrap icons and classes (also in the function changeSize()-->
      <!-- <button id="size" class="btn" onclick="changeSize()"><i class="icon-fullscreen"></i></button> -->    </span>
</div>
