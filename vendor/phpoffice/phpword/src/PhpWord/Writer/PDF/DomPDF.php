...
class DomPDF extends AbstractRenderer implements WriterInterface
{
    ...
    /**
     * Save PhpWord to file. 日本語文字化け対策 $Content = str_replace('<meta 以降
     *
    ...
    public function save($filename = null)
    {
        ...
        $Content = str_replace('<meta charset="UTF-8" />', '', $this->getContent());
        $pdf->loadHtml(str_replace(PHP_EOL, '', $Content));
