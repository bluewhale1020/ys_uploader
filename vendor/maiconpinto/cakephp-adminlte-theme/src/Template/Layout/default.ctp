...
<body class="layout-boxed hold-transition skin-<?php echo Configure::read('Theme.skin'); ?> sidebar-mini">
    <!-- Site wrapper -->
    <div class="wrapper">
...
//enter/shift+enterで次のフォーカスへ移動
    $("body").on("keypress","input:not(:hidden)",(function(e) {
var c = e.which ? e.which : e.keyCode;
if (c == 13) {
var index = $("input:not(:hidden)").index(this);
var criteria = e.shiftKey ? ":lt(" + index + "):last" : ":gt(" + index + "):first";
$("input:not(:hidden)" + criteria).focus();
//e.preventDefault();
 return false;
}
}));        
